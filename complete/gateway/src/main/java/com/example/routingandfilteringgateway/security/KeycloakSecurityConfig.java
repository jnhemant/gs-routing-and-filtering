...
//                .anonymous().disable() //
        ...
        // Refer to https://docs.spring.io/spring-security/site/docs/3.0.x/reference/el-access.html to have better understanding

        // Permit remaining requests without authentication
